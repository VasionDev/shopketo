...
@Component({
  selector: 'app-promoter-ladyboss',
  templateUrl: './promoter-ladyboss.component.html',
  styleUrls: ['./promoter-ladyboss.component.css']
})
export class PromoterLadybossComponent implements OnInit {
