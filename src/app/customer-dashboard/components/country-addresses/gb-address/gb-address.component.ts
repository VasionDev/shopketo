...
@Component({
  ...
  templateUrl: './gb-address.component.html',
  styleUrls: ['./gb-address.component.css']
})
export class GbAddressComponent implements OnInit, OnDestroy {
  ...
  getState() {
    this.loader = true;
    this.newgenSvc.getCollection(33).pipe(takeUntil(this.destroyed$)).subscribe(x => {
