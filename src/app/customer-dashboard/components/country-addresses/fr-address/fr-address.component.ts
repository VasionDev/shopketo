...
@Component({
  selector: 'app-fr-address',
  templateUrl: './fr-address.component.html',
  styleUrls: ['./fr-address.component.css']
})
export class FrAddressComponent implements OnInit, OnDestroy {
