...
@Component({
  selector: 'app-hu-address',
  templateUrl: './hu-address.component.html',
  styleUrls: ['./hu-address.component.css']
})
export class HuAddressComponent implements OnInit, OnDestroy {
