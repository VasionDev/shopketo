...
@Component({
  selector: 'app-sg-address',
  templateUrl: './sg-address.component.html',
  styleUrls: ['./sg-address.component.css']
})
export class SgAddressComponent implements OnInit, OnDestroy {
