...
@Component({
  selector: 'app-ca-address',
  templateUrl: './ca-address.component.html',
  styleUrls: ['./ca-address.component.css']
})
export class CaAddressComponent implements OnInit, OnDestroy {
  ...
  getState() {
    this.loader = true;
    this.newgenSvc.getCollection(11).pipe(takeUntil(this.destroyed$)).subscribe(x => {
