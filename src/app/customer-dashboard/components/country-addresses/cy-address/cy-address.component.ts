...
@Component({
  selector: 'app-cy-address',
  templateUrl: './cy-address.component.html',
  styleUrls: ['./cy-address.component.css']
})
export class CyAddressComponent implements OnInit, OnDestroy {
