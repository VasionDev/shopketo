...
@Component({
  selector: 'app-lt-address',
  templateUrl: './lt-address.component.html',
  styleUrls: ['./lt-address.component.css']
})
export class LtAddressComponent implements OnInit, OnDestroy {
