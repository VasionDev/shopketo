...
@Component({
  selector: 'app-es-address',
  templateUrl: './es-address.component.html',
  styleUrls: ['./es-address.component.css']
})
export class EsAddressComponent implements OnInit, OnDestroy {
