...
@Component({
  selector: 'app-ie-address',
  templateUrl: './ie-address.component.html',
  styleUrls: ['./ie-address.component.css']
})
export class IeAddressComponent implements OnInit, OnDestroy {
  ...
  getState() {
    this.loader = true;
    this.newgenSvc.getCollection(36).pipe(takeUntil(this.destroyed$)).subscribe(x => {
