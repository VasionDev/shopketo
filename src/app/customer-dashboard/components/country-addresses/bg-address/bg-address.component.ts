...
@Component({
  selector: 'app-bg-address',
  templateUrl: './bg-address.component.html',
  styleUrls: ['./bg-address.component.css']
})
export class BgAddressComponent implements OnInit, OnDestroy {
