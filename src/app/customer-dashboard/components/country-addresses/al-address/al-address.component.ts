...
@Component({
  selector: 'app-al-address',
  templateUrl: './al-address.component.html',
  styleUrls: ['./al-address.component.css']
})
export class AlAddressComponent implements OnInit, OnDestroy {
