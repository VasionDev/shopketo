...
@Component({
  selector: 'app-hr-address',
  templateUrl: './hr-address.component.html',
  styleUrls: ['./hr-address.component.css']
})
export class HrAddressComponent implements OnInit, OnDestroy {
