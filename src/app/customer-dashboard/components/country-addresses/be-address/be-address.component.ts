...
@Component({
  selector: 'app-be-address',
  templateUrl: './be-address.component.html',
  styleUrls: ['./be-address.component.css']
})
export class BeAddressComponent implements OnInit, OnDestroy {
