...
@Component({
  selector: 'app-ee-address',
  templateUrl: './ee-address.component.html',
  styleUrls: ['./ee-address.component.css']
})
export class EeAddressComponent implements OnInit, OnDestroy {
