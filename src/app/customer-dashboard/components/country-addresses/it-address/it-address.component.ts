...
@Component({
  selector: 'app-it-address',
  templateUrl: './it-address.component.html',
  styleUrls: ['./it-address.component.css']
})
export class ItAddressComponent implements OnInit, OnDestroy {
  ...
  getState() {
    this.loader = true;
    this.newgenSvc.getCollection(15).pipe(takeUntil(this.destroyed$)).subscribe(x => {
