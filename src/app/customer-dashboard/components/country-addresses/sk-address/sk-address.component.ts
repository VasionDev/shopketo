...
@Component({
  selector: 'app-sk-address',
  templateUrl: './sk-address.component.html',
  styleUrls: ['./sk-address.component.css']
})
export class SkAddressComponent implements OnInit, OnDestroy {
