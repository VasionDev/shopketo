...
@Component({
  selector: 'app-se-address',
  templateUrl: './se-address.component.html',
  styleUrls: ['./se-address.component.css']
})
export class SeAddressComponent implements OnInit, OnDestroy {
