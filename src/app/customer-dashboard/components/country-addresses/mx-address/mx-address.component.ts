...
@Component({
  selector: 'app-mx-address',
  templateUrl: './mx-address.component.html',
  styleUrls: ['./mx-address.component.css']
})
export class MxAddressComponent implements OnInit, OnDestroy {
  ...
  getState() {
    this.loader = true;
    this.newgenSvc.getCollection(17).pipe(takeUntil(this.destroyed$)).subscribe(x => {
