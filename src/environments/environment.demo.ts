export const environment = {
  ...
  shareCartDomain: 'https://{code}.mvdemo-pruvit.com/{country}/cart',
  apiDomain: 'https://api.mvdemo-pruvit.com',
  ...
  clientDomain: 'https://mvdemo-pruvit.com',
  phraseBase: 'https://api.phraseapp.com/api/v2/projects/',
  phraseAppId: 'dec2efdab93d62d55da009cb683a438a',
  phraseAppToken: 'token 98b16648a3a885dcb8bab72744c3081aa315322dbb8d0a52ddf0110e57e897e8',
  ...
  iaaConfig: {
    ...
    redirectUrl: 'https://mvdemo-pruvit.com/implicit',
    ...
    postLogoutRedirectUri: 'https://mvdemo-pruvit.com',
    startCheckSession: false,
    silentRenew: true,
    silentRenewUrl: 'https://mvdemo-pruvit.com/silent.html',
    postLoginRoute: '',
